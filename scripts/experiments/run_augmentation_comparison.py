...
def parse_args():
    ...
    parser.add_argument("--results-root", type=Path, default=Path("artifacts/augmentation-comparison"))
    parser.add_argument("--train-script", type=Path, default=Path("scripts/training/train_mk_mnet.py"))
